...
const Layout = () => {
  ...
  return (
    <div>
      ...
      <div id='show' className='w-[2.5rem] fixed right-4 bottom-12' onClick={handleShowPop}>{bolt}</div>
      <Footer />
